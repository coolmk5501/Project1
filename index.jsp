 ...
 <!--Start of  New Image slider using only CSS-->
<style>
img {
  max-width: 100%;
  height:100%;
...
.trigger:checked + .slide {
  ...
  opacity: 1;
      ...
      <div class="slider">
        ...
        <div class="left-image-holder"></div>
          <figure class="slide-figure">
            <img class="slide-img" src="http://localhost/${image.imageSlideId}/slideImage${image.fileType}"/>
            <figcaption class="slide-caption"><p>${image.caption}</p></figcaption>
           </figure><!-- .slide-figure -->
          </c:forEach>
    ...
    <!--Endof   New Image slider using only CSS-->
